...
var typed = new Typed(".typing-text", {
    strings: ["Web Developer", "Lecturer Assistant","IT Support", "Data Analyst"],
    loop: true,
    typeSpeed: 50,
    backSpeed: 25,
    backDelay: 500,
...
document.addEventListener("DOMContentLoaded", () => {
    ...
    circleSkills.forEach(circleSkill => {
      ...
      fillCircle.setAttribute("class", "fill-circle");
      ...
      circleSkill.innerHTML = "";
      circleSkill.appendChild(svg);
  
      const percent = circleSkill.dataset.percent;
      const label = circleSkill.dataset.skill;
      ...
      `;
      circleSkill.appendChild(textDiv);
    });
    ...
    const observer = new IntersectionObserver(entries => {
      entries.forEach(entry => {
        if (entry.isIntersecting) {
          ...
          circleSkills.forEach(circleSkill => {
            const percent = circleSkill.dataset.percent;
            const fillCircle = circleSkill.querySelector(".fill-circle");
            const textPercent = circleSkill.querySelector(".percent");
